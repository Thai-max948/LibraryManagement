...
namespace LibraryManagement.Services
{
    public class BookService
    {
        ...
        {
            Validate(book);
            book.AvailableQuantity = book.Quantity; // sách mới -> full available
        ...
        public void UpdateBook(Book book)
        {
            ...
            book.AvailableQuantity = book.Quantity - borrowing; // giữ nguyên số đang mượn
        ...
        public List<Book> SearchBook(string keyword)
            => string.IsNullOrWhiteSpace(keyword) ? _bookRepo.GetAll() : _bookRepo.Search(keyword);
